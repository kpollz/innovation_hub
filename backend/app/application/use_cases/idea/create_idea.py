...
from app.application.dto.idea_dto import CreateIdeaDTO, IdeaResponseDTO
...
class CreateIdeaUseCase:
    ...
    async def execute(
        ...
        Args:
            dto: Creation data
            author_id: ID of the user creating the idea
        ...
        created_idea = await self.idea_repo.create(idea)
        
        # Return as DTO
        return IdeaResponseDTO.model_validate(created_idea)
