...
> **Logic khi có problem_id**: Tự động chuyển problem status sang `brainstorming`.
...
- **Status**: 201 Created
- **Logic**: Tạo room với `problem_id` liên kết, chuyển problem status sang `brainstorming`.
